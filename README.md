**goit-js-hw-09 ** _Модуль 10 - Асинхронність та Date. Проміси._

- **Этот проект был создан при помощи Parcel. [Parcel template](README.md).**
...
символов. Напиши функцию `addLeadingZero(value)`, которая использует метод метод
